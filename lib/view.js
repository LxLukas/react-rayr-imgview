        ...
        var Modal = function (_Component) {
            ...
            _createClass(Modal, [{
                ...
                value: function DragStart(e) {
                    ...
                    var oldTfInfo = oldTransform.match(/\((.+)\)/)[0]; // 匹配括号里的字符串
                ...
                value: function render() {
                    ...
                    var style = { transform: 'scale(' + iNow + ') rotate(' + rotate + 'deg) translate(' + posX + 'px, ' + posY + 'px) rotateY(' + rotateY + 'deg) rotateX(' + rotateX + 'deg)' };
                    var imgStytle = {};
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { onDragEnd: t.onDragEnd.bind(this), draggable: 'true', onDragStart: t.DragStart.bind(this), className: 'imgview-box', ref: 'imgviewImg', style: style },
                            _react2.default.createElement('img', { ref: 'imgSrc', src: src, style: imgStytle }),
                            _react2.default.createElement('canvas', { id: 'imgCanvas', className: 'img-canvas' })
                        ),
                        _react2.default.createElement(
                            'div',
